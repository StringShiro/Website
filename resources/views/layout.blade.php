...
use App\Customer;
                                ...
                                <?php
                                   ...
                                   if($customer_id!=NULL){ 
                                 ?>
                                  <li><a href="{{URL::to('/history')}}"><i class="fa fa-book"></i> Lịch sử đơn hàng</a></li>
                                <?php 
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a target="blank" href="{{URL::to('/history')}}">Lịch sử mua hàng</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-5">
    ...
    <script>
        ...
        onAuthorize: function(data, actions) {
            return actions.payment.execute().then(function(){
                ...
                window.alert('Cảm ơn vì đã mua hàng của chúng tôi!');
            });
        }
    }, '#paypal-button');
    </script>
